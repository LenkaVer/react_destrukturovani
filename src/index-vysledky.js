...
// =========== UKOL 1, DESTRUKTUROVÁNÍ //
{
    ...
    */
    ...
    // 2b (varianta)
    // Všimni si, že díky zabalení bloku do chlupatých závorek {} (níže) mohu definovat znovu konstantu colors,
    // kterou už jsem použil v řešení 2a. (viz obor platnosti = scope) Vřele to ale nedoporučuju :-)
    // Lepší opravdu pro každou proměnnou mít vlastní název ;-)
